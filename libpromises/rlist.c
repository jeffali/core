...
static Rlist *parse4(const char *str, const char *left, const char *right) {
   //assert( str[0]             == "\"" )
...
static Rlist *parse3(const char *str, const char *left, const char *right) {
   Rlist *newlist = NULL;
   char str2[CF_MAXVARSIZE];
   char *s = left;
   char *s2 = str2;
...
static char *trim_left3(const char *str) {
  char *s = str;
...
static char   *trim_right2(const char *str) {
...
static char   *trim_right3(const char *str) {
  bool crossed = false;
  char *s = str + strlen(str) - 1;
  while(*s && s>str) {
    if(crossed==false) {  
...
#if 0
int main() {
   //char *str="   {  abSBc,dS,eSAfg,hiSSjk,lm  }  ";
   //char *str="   {  ab\\Bc,d\\,e\\Af\\\"g,hi\\\\jk,lm  }  ";
   ...
   //trim_left(str, str2);
   printf("[%s]\n", trim_left2(str));
   printf("[%s]\n", trim_left2("{{")?trim_left2("{{") :"NULL");
   printf("[%s]\n", trim_left2("")?trim_left2("") :"NULL");

   printf("[%s]\n", trim_right2("aaaaaaa }   ")?trim_right2("aaaaaaa }   ") :"NULL");
   printf("[%s]\n", trim_right2("}")?trim_right2("}") :"NULL");
   printf("[%s]\n", trim_right2("")?trim_right2("") :"NULL");
   printf("[%s]\n", trim_right2("bbbbb")?trim_right2("bbbbb") :"NULL");

   parse2(str, trim_left2(str), trim_right2(str));
   printf("%s\n", str2);
   trim_right(str2, str3);
   printf("%s\n", str3+1);
   parse(str3+1);
   return 0;
}
...
Rlist *RlistParseShown2(char *string)
{
    Rlist *newlist = NULL;
/* Parse a string representation generated by ShowList and turn back into Rlist */
